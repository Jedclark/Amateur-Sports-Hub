...
public class AddFootballScoreActivity extends AppCompatActivity {
    ...
    private InterfaceHelper interfaceHelper = new InterfaceHelper(this, AddFootballScoreActivity.this);

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_add_football_score);
    ...
    public void enterScores(View view){
        final String homeTeamGoals = interfaceHelper.getTextFromEditText(R.id.add_football_score_activity_home_score_edit);
        final String awayTeamGoals = interfaceHelper.getTextFromEditText(R.id.add_football_score_activity_away_score_edit);
        ...
        if(homeTeamGoals.equals("") || awayTeamGoals.equals("")){
            ...
            final String goals = Arrays.deepToString(goalsArray);
                        ...
                        StringRequest request = new StringRequest(Request.Method.POST, APIHelper.FIND_TEAM_BY_ID + awayTeamID, new Response.Listener<String>() {
                            ...
                            public void onResponse(String response) {
                                ...
                                try {
                                    ...
                                    APIHelper.sendData(getApplicationContext(), Request.Method.POST, APIHelper.ADD_FOOTBALL_SCORE, map);
                                    ...
                                    if(type.equals("league")){
                                        ...
                                        updateFootballPerformance(home, away);
                                    }
    ...
    private void updateFootballPerformance(final int homeTeamGoals, final int awayTeamGoals){
        RequestQueue queue = Volley.newRequestQueue(this);
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if(homeTeamGoals > awayTeamGoals){
                        ...
                        int draws = Integer.parseInt(home.getDraws()) + 1;
                        homeMap.put("points", String.valueOf(points));
